...
<header>
        ...
        <nav>
            <ul>
                <li><a href="/daw/Tema6/Vsgame_GD/admin/dashboard.php">Inicio</a></li>
                <li><a href="/daw/Tema6/Vsgame_GD/admin/cards/cards.php">Cartas</a></li>
                <li><a href="daw/Tema6/Vsgame_GD/admin/config/config.php">Configuración</a></li>
                <li><a href="/daw/Tema6/Vsgame_GD/admin/logout.php"><?php echo $nombre;?> (Cerrar Sesión)</a></li>
            </ul>
        </nav>
    </header>
